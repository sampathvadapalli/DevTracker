...
class App extends Component {
    constructor(props) {
        ...
        this.handlePlacementDateErrorfromAdd_Row = this.handlePlacementDateErrorfromAdd_Row.bind(this);
    ...
    handlePlacementDateErrorfromAdd_Row(data) {this.setState({PlacementDateError : data});}
    onClick() {
        this.child.current.handleChangeDate();
    }
    ...
    rows() {
        return (this.state.tablerows.map( row_add => {
            return (<Add_Row ref={this.child} cardNotoApp={this.handlecardNofromAdd_Row} JobtoApp={this.handleJobfromAdd_Row} MentortoApp={this.handleMentorfromAdd_Row} HrtoApp={this.handleHrfromAdd_Row} DatetoApp={this.handlePlacementDatefromAdd_Row} DateErrortoApp={this.handlePlacementDateErrorfromAdd_Row} PlacementStatustoApp={this.handlePlacementStatusfromAdd_Row} handleOpenModal={this.handleOpenModal} isModalOpen={this.state.isModalOpen}/>);}
        ))
    }
                ...
                <Table className="table" isStriped={true} isPadded={true}>
                    ...
                    <Table.Rows>
                        {this.requests.map((item,i) =>{
                            ...
                            if(this.state.getReqLen === this.state.allReqLen)
                            {
                                if(item.placement_by.includes("B"))
                                {
                                            ...
                                            return(
                                                <Table.Row key={i}>
                                                    ...
                                                    <Table.Cell key="ROW_PLACEMENT_BY" content={
                                                        <Card.Body error={this.state.PlaceDateError} isContentCentered={true} hasPaddingVertical={true} hasPaddingHorizontal={true}>
                                                            <DatePicker onClick={this.onClick} minDate={minimum_date} disabled={this.state.card_no_entered} selectedDate={this.state.selectedDate} name = "placement-date" filterDate={isWeekday} />
                                                        </Card.Body>
                                                    }/>
